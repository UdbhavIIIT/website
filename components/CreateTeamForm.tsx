...
export default function CreateTeamForm({ onSuccess }: CreateTeamFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                alert(`Team created successfully! Your team code is: ${data.team.teamCode}. Share this code with your teammates.`);
                router.refresh();
            } else {
    ...
    return (
        <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold text-center mb-6 text-gray-800">Create Your Team</h2>
            ...
            <div className="mt-4 text-sm text-gray-600 text-center">
                <p>After creating your team, you'll receive a unique team code to share with your teammates.</p>
            </div>
        </div>
    );
}
