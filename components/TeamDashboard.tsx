    ...
    return (
        <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
            <div className="flex justify-between items-start mb-6">
                <div>
                    ...
                    <div className="flex items-center mt-2">
                        <span className="text-sm text-gray-500">Created on {formatDate(team.createdAt)}</span>
                        {isLeader && (
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Share this code with your teammates</p>
                        </div>
                        <div className="flex items-center space-x-2">
                            <div
                                className={`text-2xl font-mono tracking-wider px-4 py-2 rounded border-2 border-dashed ${showCode ? 'border-blue-300 bg-blue-50' : 'border-gray-300 bg-gray-100'
                                    }`}
                            >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className={`text-2xl font-bold ${team.isActive ? 'text-green-600' : 'text-red-600'}`}>
                        ...
                        <div key={member.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    {member.batch && (
                                        <div className="text-xs text-gray-500">Batch: {member.batch}</div>
                                    )}
                                </div>
                            </div>
                            {member.phone_number && (
